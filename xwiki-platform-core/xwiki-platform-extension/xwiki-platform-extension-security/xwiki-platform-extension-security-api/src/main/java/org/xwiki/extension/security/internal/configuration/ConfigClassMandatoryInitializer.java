...
import static org.xwiki.extension.security.internal.configuration.DefaultExtensionSecurityConfiguration.FALSE_POSITIVE_URL;
...
public class ConfigClassMandatoryInitializer extends AbstractMandatoryClassInitializer
{
    ...
    protected void createClass(BaseClass xclass)
    {
        ...
        xclass.addTextField(FALSE_POSITIVE_URL, "False Positive URL", 30);
    }
}

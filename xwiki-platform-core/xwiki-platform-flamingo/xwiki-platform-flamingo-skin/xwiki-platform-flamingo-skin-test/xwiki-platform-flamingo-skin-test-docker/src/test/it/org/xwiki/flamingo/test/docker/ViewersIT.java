...
class ViewersIT
{
    ...
    void siblings(TestUtils testUtils, TestReference testReference)
    {
        ...
        guestTableLayoutElement.assertCellWithLink("Title", "ChildA", testUtils.getURL(childADocumentReference));
        guestTableLayoutElement.assertRow("Date", hasItem(guestTableLayoutElement.getDatePatternMatcher()));
        guestTableLayoutElement.assertCellWithLink("Last Author", "XWikiGuest",
            testUtils.getURL(new DocumentReference("xwiki", XWIKI_SPACE, GUEST_USER)));
        guestTableLayoutElement.assertCellWithLink("Actions", "Copy",
        ...
        adminTableLayoutElement.assertCellWithLink("Title", "ChildA", testUtils.getURL(childADocumentReference));
        adminTableLayoutElement.assertCellWithLink("Actions", "Copy",
            testUtils.getURL(childADocumentReference, "view", "xpage=copy"));
        adminTableLayoutElement.assertCellWithLink("Actions", "Rename",
            testUtils.getURL(childADocumentReference, "view", "xpage=rename&step=1"));
        adminTableLayoutElement.assertCellWithLink("Actions", "Delete",

...
/**
 * Base class for the configuration sources using {@code Image.Style.Code.ConfigurationClass} XObjects.
 *
 * @version $Id$
 * @since 14.2RC1
 */
public abstract class AbstractWikiImageStyleConfigurationSource extends AbstractXClassConfigurationSource
{
    ...
    {
        return new DocumentReference(XOBJECT_REFERENCE, getWikiReference());
    }

    protected abstract WikiReference getWikiReference();
}

 ...
 * class is named {@code R140500000XWIKI15460} in branch {@code 14.5RC1+}.
 *
 * @version $Id$
...
@Component
@Singleton
@Named("R131006000XWIKI15460")
@Unstable
public class R131006000XWIKI15460DataMigration extends AbstractHibernateDataMigration
{
    @Inject
    ...
    {
        return new XWikiDBVersion(131006000);
    }
